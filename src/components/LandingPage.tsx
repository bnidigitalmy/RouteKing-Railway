  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      {showMarketing ? (
        ...
        <section className="pt-32 pb-20 px-6 flex items-center justify-center min-h-[85vh] bg-gray-50">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="w-full max-w-md bg-white p-10 rounded-[3rem] shadow-2xl border border-gray-100 text-center space-y-10 relative overflow-hidden"
          >
            {/* Background Accent */}
            <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-blue-600 to-indigo-600"></div>
            
            <div className="space-y-4">
              <div className="w-20 h-20 bg-blue-600 rounded-[2rem] mx-auto flex items-center justify-center shadow-2xl shadow-blue-200 ring-8 ring-blue-50">
                <Package className="text-white w-10 h-10" />
              </div>
              <div className="space-y-2">
                <h1 className="text-3xl font-black tracking-tight text-gray-900">Selamat Kembali!</h1>
                <p className="text-gray-500 font-medium">Log masuk untuk mula susun route anda hari ini.</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <button 
                onClick={onStart}
                disabled={isLoggingIn}
                className="w-full py-5 bg-blue-600 text-white rounded-2xl font-black text-lg shadow-xl shadow-blue-100 hover:bg-blue-700 transition-all active:scale-95 flex items-center justify-center gap-4 group"
              >
                ...
                {isLoggingIn ? 'Menyambung...' : 'Log Masuk dengan Google'}
              </button>
              ...
              <div className="bg-blue-50/50 p-4 rounded-2xl border border-blue-100 flex items-center justify-center gap-2">
                <CheckCircle2 className="text-blue-600" size={16} />
                <span className="text-xs font-bold text-blue-700">Tiada kad diperlukan untuk mendaftar</span>
              </div>
            </div>

            <div className="pt-4">
              <p className="text-[10px] text-gray-400 leading-relaxed uppercase font-black tracking-widest">
                Legal & Safety
              </p>
              <div className="flex justify-center gap-4 mt-2">
                <button onClick={() => openLegal('terms')} className="text-[10px] text-blue-600 font-bold hover:underline">Syarat Perkhidmatan</button>
                <button onClick={() => openLegal('privacy')} className="text-[10px] text-blue-600 font-bold hover:underline">Dasar Privasi</button>
              </div>
            </div>
          </motion.div>
        </section>
          ...
          <section className="py-24 bg-gray-50">
            <div className="max-w-7xl mx-auto px-6">
              <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
                <h2 className="text-4xl font-black text-gray-900 tracking-tight">Kelebihan Optimasi Laluan & Kurier RouteKing</h2>
                <p className="text-gray-500 font-medium">Kami faham penat lelah rider. Sebab itu kami bina alat yang memudahkan kerja harian anda dengan teknologi geocoding terbaik di Malaysia.</p>
              </div>
          ...
          <section className="py-24 px-6 bg-gray-50">
            <div className="max-w-7xl mx-auto">
              <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                ...
                <p className="text-gray-500 font-medium">Peluburan kecil untuk hasil yang besar setiap hari.</p>
              </div>
